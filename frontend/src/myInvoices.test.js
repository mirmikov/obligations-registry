...
const items = [
  { id: 1, counterparty: 'Альфа', legal_entity: 'ООО Мирт', document_number: 'Счёт 1', amount: 100, planned_payment_date: '2026-08-01', status: 'Зарегистрирован', responsible: 'Иванов И.И.' },
  { id: 2, counterparty: 'Бета', legal_entity: 'ООО Мирт-МРТ', document_number: 'Счёт 2', amount: 200, planned_payment_date: '2026-08-20', approval_date: '2026-08-11', status: 'К оплате', responsible: 'Иванов И.И.' },
  { id: 3, counterparty: 'Гамма', legal_entity: 'ООО Мирт', document_number: 'Счёт 3', amount: 300, planned_payment_date: '2026-07-20', actual_payment_date: '2026-07-21', status: 'Оплачено', responsible: 'Петров П.П.' },
]
