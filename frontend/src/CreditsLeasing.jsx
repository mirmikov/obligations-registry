...
export default function CreditsLeasing({ user, notify }) {
  ...
  return <div className="page credits-page">
    ...
    {details && <CreditDayDetails details={details} loading={detailsLoading} savingCells={detailsSaving} editable={legalEntity => canApproveObligations(user, legalEntity)} onCommit={saveDetailField} onClose={closeDetails}/>}
  </div>
}
